...
To determine the acceptable range of failure rate, we decided to use the Interquartile Range Method to determine outliers. The steps below outlined our process:
...
## Discussing the advantages and disadvantages of reliability growth analysis

Advantages of reliability growth analysis:
- Allows for early identification of weaknessess or faults within a system
- Provides predictive insights into the future reliability performance of a system
- Promotes continous improvement
- Data-driven decision making as empirical data is collected during testing

Disadvantages of reliability growth analysis: 
- Requires significant resources
- Analysis can be complex and challenging
- Accuracy of predictions may be limited
- Potential for bias if data interpretation is influenced by preconceived notions

Despite the ability to predict the future reliability performance of a system, reliability growth analysis can serve as a difficult method to analyze a system's reliability. Interpreting reliability growth data may be challenging due to the intricate interplay of various factors influencing reliability trends, including environmental conditions, usage patterns, and the presence of latent defects.
...
## Discussing the advantages and disadvantages of Reliability Demonstration Charts

Advantages of Reliability Demonstration Charts:
- Visual representation of failure data which is easy to read and understand
- Allow for scenario analysis by adjusting the MTTF parameter
- Provide an objective method to evaluate the system's reliability performance

Disadvantages of Reliability Demonstration Charts:
- Sensitive to assumptions made in setting reliability targets
- Limitive preditive capability for future performance
- Depends heavily on the quality and completeness of failure data collected

While RDCs offer benefits in visually assessing and decision-making, they lack in predictive capability and are left open to interpretation. 

# Comparison of Results

Both reliability growth testing and reliability demonstration charts used distinct approaches throughout this lab to assess the reliability of a hypothetical system, given its failure data collected during integration testing. The results where as follows:

Reliability Growth Testing:
- Focus: Monitor the evolution of reliability over time as testing progresses. Identify trends in failure rates and predict future reliability performance.
- Data Analysis: Failure data was collected during testing and analyzed to fit the Truncated Logistic and Discrete Weibull models. These models were selected as they has the lowest AIC and BIC values. The failure data was then further analyzed to remove outliers, by using the Interquartile Range Method.
- Outcome: Through our experimentation, we determined that utilizing 70% of the available data yielded optimal results. We also determined the acceptable range of failure rate as -5.23649629057301 to 16.026619747363135.

Reliability Demonstration Chart:
- Focus: Asessing whether the system meets predefined reliability targets. Based on inter failutre times only and target failure rate.
- Decision Making: Helps in making acceptability decisions based on predefined reliability targets. The RDC provides a graphical representation of failure data plotted against reliability targets, leading to more informed decisions about the acceptability of the system's reliability.
- Outcome: The MTTFmin was determined to be approximately 0.0038. This value was identified as the threshold at which the plotted line fell just within the acceptable region of the RDC chart.

The results obtained from reliability growth testing and reliability demonstration charts provided insights into the reliability of the hypothetical system. While reliability growth testing focused on tracking the system's evolution over time and predicting future performance trends, the reliability demonstration chart assessed whether the system met predefined reliability targets.
